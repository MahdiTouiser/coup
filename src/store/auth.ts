...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    setToken: (state, action: PayloadAction<AuthData>) => {
      ...
      state.securityInformationCompleted =
        action.payload.securityInformationCompleted;
      state.personalInformationCompleted =
        action.payload.personalInformationCompleted;
    },
    signUpPhone: (
      state,
    ...
    setUserStatus: (state, action: PayloadAction<string>) => {
      ...
      state.userStatusDisplay =
        UserStatusesPersianMap.get(action.payload) || '';
    },
    setHttpHeader: (state) => {
